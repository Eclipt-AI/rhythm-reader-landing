    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-700">
          ...
          <a href="#community" className="hover:text-orange transition-colors">
            Play
          </a>
          <a href="#join" className="hover:text-orange transition-colors">
            Join
          </a>
          <a href="#reviews" className="hover:text-orange transition-colors">
            Take Note
          </a>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 space-y-4 text-sm">
          <a
            href="#about"
            className="block text-gray-700 hover:text-orange"
          ...
          <a
            href="#join"
            className="block px-5 py-2 bg-orange text-white text-center rounded-full font-medium"
            onClick={() => setMobileOpen(false)}
          >
            Join
          </a>
